...
OPTEE_OS_PATH			?= $(ROOT)/optee_os-3.21.0
# OPTEE_CLIENT_PATH		?= $(ROOT)/optee_client
OPTEE_CLIENT_PATH		?= $(ROOT)/optee_client-3.21.0
OPTEE_CLIENT_EXPORT		?= $(OPTEE_CLIENT_PATH)/out/export
# OPTEE_TEST_PATH			?= $(ROOT)/optee_test
# OPTEE_TEST_OUT_PATH		?= $(ROOT)/optee_test/out
OPTEE_TEST_PATH			?= $(ROOT)/optee_test-3.21.0
OPTEE_TEST_OUT_PATH		?= $(ROOT)/optee_test-3.21.0/out
...
# add llvm library support
BR2_PACKAGE_LLVM ?= y
# add i2c tools support
...
# CFG_ULIBS_SHARED=y (ERROR)
# CFG_TEE_CORE_DEBUG=4 (ERROR)
