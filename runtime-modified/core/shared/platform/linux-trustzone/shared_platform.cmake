...
if ("$ENV{OPTEE_DIR}" STREQUAL "")
  set (OPTEE_DIR "/opt/watz-gpio")
else()
  set (OPTEE_DIR $ENV{OPTEE_DIR})
endif()

#include_directories (${OPTEE_DIR}/optee_os-3.21.0/out/arm/export-ta_arm64/include)
include_directories (${OPTEE_DIR}/optee_os-3.21.0/lib/libutee/include)
include_directories (${OPTEE_DIR}/optee_os-3.21.0/lib/libutils/ext/include)
