...
#include "../interpreter/tz_periph_io_helper.h"
 ...
 */
WASM_RUNTIME_API_EXTERN void
tzio_set_output_buffer(uint8_t *buffer, uint64_t buffer_size);

#define N_IO_SIG 64

/**
 * @brief periph to io helper map
 * @param periph_type periph type
 * @param periph_no periph number
 * @param io_helper_uuid put uuid
 */
...
/**
 * @brief periph io map to signal no
 */
WASM_RUNTIME_API_EXTERN
