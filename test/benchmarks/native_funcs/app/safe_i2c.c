...
int main(int argc, char **argv)
{
    ...
    res=i2c_write_bytes(I2C_TEST_NO,I2C_TEST_ADDR,I2C_TEST_FLAG,signed_data,I2C_TEST_LEN);
    ...
    record_benchmark_time(0);
    signed_data=sign_ptr(data,SIGNATURE,TAG);
    res=i2c_read_bytes(I2C_TEST_NO,I2C_TEST_ADDR,I2C_TEST_FLAG,signed_data,I2C_TEST_LEN);
    record_benchmark_time(1);
    get_benchmark_time(0,(uint32_t)&start);
    get_benchmark_time(1,(uint32_t)&end);
