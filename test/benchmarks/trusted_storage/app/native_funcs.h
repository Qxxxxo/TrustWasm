...
__attribute__((import_name("i2c_get_overhead_timestamp"))) int
i2c_get_overhead_timestamp(uint32_t buf_addr);

__attribute__((import_name("io_helper_get_overhead_timestamp"))) int
io_helper_get_overhead_timestamp(uint32_t buf_addr);
