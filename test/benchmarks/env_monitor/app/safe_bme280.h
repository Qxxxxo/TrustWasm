...
int bme280_sample_async_future(uint32_t i2c_no,uint32_t i2c_addr){
    return i2c_read_regs_async_future(i2c_no,i2c_addr,0,BME280_REG_PRESS_MSB,8);
}

int bme280_sample_async(uint32_t i2c_no,uint32_t i2c_addr, uint32_t handler_func_ptr){
    return i2c_read_regs_async(i2c_no,i2c_addr,0,BME280_REG_PRESS_MSB,8,handler_func_ptr);
}
