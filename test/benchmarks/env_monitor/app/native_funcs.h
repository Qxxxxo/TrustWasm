...
__attribute__((import_name("bh1750fvi_sample_async"))) int
bh1750fvi_sample_async(uint32_t i2c_no, uint32_t addr, uint32_t handler_func_ptr);
...
__attribute__((import_name("i2c_read_regs_async"))) int 
i2c_read_regs_async(uint32_t i2c_no, uint32_t i2c_addr, uint32_t flags, uint32_t reg, uint32_t read_len, uint32_t handler_func_ptr);

__attribute__((import_name("dht_read_async"))) int 
dht_read_async(uint32_t pin, uint32_t type, uint32_t handler_func_ptr);
