...
build_safe_sync () {
    /opt/wasi-sdk/bin/clang $BM_CFLAGS \
        ...
        -Wl,--strip-all \
        -I $SCRIPT_DIR/app \
        -o app/poll.wasm $SCRIPT_DIR/app/safe_sync.c 
    
    compileaot $SCRIPT_DIR/app/poll
}
...
build_safe_async () {
    /opt/wasi-sdk/bin/clang $BM_CFLAGS \
        ...
        -Wl,--strip-all \
        -I $SCRIPT_DIR/app \
        -o app/poll.wasm $SCRIPT_DIR/app/safe_async.c 
...
build_sync () {
    /opt/wasi-sdk/bin/clang $BM_CFLAGS \
        ...
        -Wl,--strip-all \
        -I $SCRIPT_DIR/app \
        -o app/poll.wasm $SCRIPT_DIR/app/sync.c 
...
build_async () {
    /opt/wasi-sdk/bin/clang $BM_CFLAGS \
        ...
        -Wl,--strip-all \
        -I $SCRIPT_DIR/app \
        -o app/poll.wasm $SCRIPT_DIR/app/async.c 
...
build_something (){
    ...
    /opt/wasi-sdk/bin/clang $BM_CFLAGS \
        ...
        -Wl,--strip-all \
        -I $SCRIPT_DIR/app \
        -o app/poll.wasm $SCRIPT_DIR/app/$SOMETHING 
