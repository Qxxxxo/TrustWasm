...
announcedeploy "simple_async app"
cd $SCRIPT_DIR
rsync --progress -r $BM_BUILDER_HOSTNAME:$BM_BUILDER_PATH/simple_async/app/\*.wasm out/
rsync --progress -r $BM_BUILDER_HOSTNAME:$BM_BUILDER_PATH/simple_async/app/\*.aot out/
