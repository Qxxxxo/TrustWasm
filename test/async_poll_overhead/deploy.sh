...
cd $SCRIPT_DIR
rsync --progress -r $BM_BUILDER_HOSTNAME:$BM_BUILDER_PATH/async_poll_overhead/app/\*.wasm out/
rsync --progress -r $BM_BUILDER_HOSTNAME:$BM_BUILDER_PATH/async_poll_overhead/app/\*.aot out/
